...
static inline int snd_ctl_add(struct snd_card *card, struct snd_kcontrol *kcontrol)
{
  return -1;
}
static inline struct snd_kcontrol *snd_ctl_new1(const struct snd_kcontrol_new * kcontrolnew, void * private_data)
{
  return NULL;
}
